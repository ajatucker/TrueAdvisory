                ...
                <div class="course">
                    <div class="newCourseInfo">
                        ...
                        <h3 style="text-align:center;">
                            <input type="text" class="form-control user-form" style= "width: 60%;" name="dept" value="Department">
                            <input type="text" class="form-control user-form" style= "width: 60%;" name="c-id" value="Course Identifier (CIS101)">
                            <input type="text" class="form-control user-form" style= "width: 60%;" name="c-name" value="Full Course Name">
                        </h3>
                    </div>

                    <input type="textarea" class="form-control user-form" style= "height: 100px; width: 80%;" name="desc" value="Enter Course Information Here" style = "height: 100px; word-wrap: break-word;">
                    <br>                   
                </div>
