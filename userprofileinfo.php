                ...
                <div class="col-md-3">
                    <div class="card mb-4 box-shadow">
                        <div class="card-body" style= "height: 200px">
                                ...
                                <h5 style = "margin-top: 40px; margin-bottom:20px">
                                    Email: <?=$email?>
                                </h5>
                    ...
                    <?php
                        if($_SESSION['adminPrivileges'] == 0){
                            ...
                            echo '<div class="col-sm-6">
                                    <form action="./backend/request-admin.php" method="POST" id="req-admin-form">
                                            <input type="submit" name="req-admin" id="req-admin" class="btn btn-default"  style ="margin-left: 5px;" value="Admin Request"/>
                                    </form>
                                    </div>';
                        }
                        if($_SESSION['tutorPrivileges'] == 0){
                                    ...
                                    <form action="./backend/request-tutor.php" method="POST" id="req-tutor-form">
                                            <input type="submit" name="req-tutor" id="req-tutor" class="btn btn-default"   style ="margin-left: 5px;"value="Tutor Request"/>
                                    </form>
                                    </div>';
                        }
                ...
                <div class="col-lg-6">
                    <div class="card mb-4 box-shadow">
                        <div class="card-body">
                            ...
                            <?php foreach ($currCourse as $course) : ?>
                            <div class="card mb-4 box-shadow" style ="margin-top: 20px;">
                                <div class="card-body">     
                                <div class="row">
                                     <h5>
                                            <?php echo $course['courseID'];?>
                                    ...
                                    <div class="input-group-append">
                                        ...
                                        <input type="submit" name="remove-course-submit" id="remove-course-submit" class="btn btn-outline-secondary" value="Remove" style="background-color:#E90000; color: white; margin-left: 500px"/>
                                    </div>
                                    </form>
                                </h5>
                            </div>
                            ...
                            <div class="card mb-4 box-shadow">
                                <div class="card-body">
                                    ...
                                    <?php 
                                                            if($_SESSION['tutorPrivileges'] == 0)
                                                            {
                                                                echo "<h5 style ='margin-top: 20px;'>You're not a tutor.<h5>";
                                                            }
                                                        ?>
